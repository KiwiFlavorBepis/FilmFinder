...
def create_retry_session(retries=3, backoff_factor=0.3, status_forcelist=(500, 502, 504, 429, 403), session=None):
    """
...
if __name__ == "__main__":
    ...
    output.to_csv(f'../Datasets/scraped_{start_line}_{end_line}.csv', index=False)
